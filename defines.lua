...
NDiplomacy = {
	...
	PO_DEMAND_PROVINCES_AE = 0.8, 				-- _DDEF_PO_DEMAND_PROVINCES_AE = 10, (Per development)
...
NCountry = {
	...
	INSTITUTION_BONUS_FROM_IMP_DEVELOPMENT = 1,
...
NEconomy = {
	...
	MISSIONARY_MAINTENANCE_FACTOR = 0.5,				-- How much a missionary costs in itself
	MISSIONARY_MAINTENANCE_DEVELOPMENT_FACTOR = 2.0,	-- How much this is ncreased from development
...
NMilitary = {
	...
	BASE_MP_TO_MANPOWER = 0.250,		-- 250 men per manpower
	SIEGE_ATTRITION = 1,
	...
	LIGHT_SHIP_COST = 25, 							-- _MDEF_LIGHT_SHIP_COST = 10,
	...
	FLAGSHIP_COST_DUCATS = 200,						-- The cost in ducats of a flagship
